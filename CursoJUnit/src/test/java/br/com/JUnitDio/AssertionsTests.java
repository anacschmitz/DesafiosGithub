...
public class AssertionsTests {
    @Test
    public void validarValoresDeOperacoes() {
    ...
    @Test
    public void validarSeArraysSaoIguais() {
    ...
    @Test
    public void validarSeObjetoEstaNuloOuNao() {
    ...
    @Test
    public void validarQueAlgumaCondicaoEhVerdadeira() {
